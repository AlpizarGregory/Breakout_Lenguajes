...
public class GameState {
    ...
    public GameState(){
        ...
        player = new Player(new Vector2D(100.0,580.0), Assets.player);
        ...
        blocksMatrix[7][0].setState("addLive");
        blocksMatrix[7][1].setState("addLive");
        blocksMatrix[7][2].setState("addLive");
        blocksMatrix[7][3].setState("addLive");
